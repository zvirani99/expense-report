/*
  # Fix is_admin() Function, Add Trigger, and Update Policies (Version 2)

  This migration aims to fix the "failed to fetch reports" error by addressing potential issues with the `is_admin()` function, its usage in RLS policies, and the setup of the `user_roles` table. This is version 2, addressing potential issues from the previous migration.
